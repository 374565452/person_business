...
{
    public class WaterCmd_25_1 : WaterBaseMessage
    {
        public WaterCmd_25_1()
        {
            AFN = (byte)WaterBaseProtocol.AFN._25;
        ...
        public string ReadMsg()
        {
            ...
            try
            {
                RType = Convert.ToByte(UserData.Substring(16, 2), 16);
            }
            catch (Exception ex)
            {
            ...
            try
            {
                IsSend = Convert.ToByte(UserData.Substring(18, 2), 16);
            }
            catch (Exception ex)
            {
